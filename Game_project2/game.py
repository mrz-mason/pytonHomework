        ...
        def repeat_code():
            def chosen_option():
                ...
                if chosen_option == "Дом одной из жертв":
                    print(
                        "Вы подъезжаете к дому жертвы и видете напротив этого дома, дом соседа, который сидит на крыльце")
                    print("Вы заходите в дом")

                    def proof1():
                        proof1 = input(
                            "Что вы хотите сделать? (поиск улик на первом этаже/поиск улик на втором этаже): ")
                        if proof1 == "поиск улик на первом этаже":
                            print(
                                "Вы обошли весь этаж найдя следы крови, которые не были обнаруженны при первичном осмотре места приступления.")
                            print("Вы взяли её на анализ")
                            print(
                                "Также детально осмотрев место борьбы жертвы и приступника. Вы анализируя как пристпник мог уйти и идёте по тому пути. \nВыйдя на этот путь недалеко от дома вы находите орудие преступления")
                            step = input(
                                "Что делать дальше ? (пойти поговорить с соседом/поехать в полицейский участок)")
                            ...
                            print(
                                "Вы заходите в дом и сразу направляетесь на второй этаж. В надежде что там есть какие-либо зацепки")
                            ...
                            if step3 == "слева":
                                ...
                                print(
                                    "Вы осмотрели книжные полки и стол. Но кроме очень страх документов и книг вы ничего не нашли")
                                print(
                                    "Потом вы пошли в комнату напротив этой. Там была детская в которой тоже уже давно никто не бывал.")
                                print("Поискав там, вы тоже ничего не нашли")
                                print(
                                    "Потом вы пошли в оставшуюся комнату. Но увы, это была супружеская спальня. В котрой точно также никого не было уже давно")
                                print("Вы обыскали и эту комнату, но как и в других комнатах ничего не нашли")
                                print(
                                    "Поняв, что второй этаж заброшен и им никто не пользуется. Вы спустились на первым и решили поискать там.")
                                print(
                                    "Вы обошли весь этаж найдя следы крови, которые не были обнаруженны при первичном осмотре места приступления.")
                                print("Вы взяли её на анализ")
                                print(
                                ...
                                print(
                                    "Зайдя в комнату напротив вы увидели кабинет. В которм уже тоже давно никого не было.")
                                print("Всё было в прильнчом слое пыли, в углах даже паутина появилась. ")
                                print(
                                    "Вы осмотрели книжные полки и стол. Но кроме очень старых документов и книг вы ничего не нашли")
                                print(
                                    "Потом вы пошли в оставшуюся комнату. Но увы, это была супружеская спальня. В котрой точно также никого не было уже давно")
                                print("Вы обыскали и эту комнату, но как и в других комнатах ничего не нашли")
                                print(
                                ...
                                print(
                                    "Вы вы пошли в комнату которая была по прямой. Это была супружеская спальня. В котрой никого не было уже давно")
                                print("Вы обыскали и эту комнату, но ничего не нашли")
                                print(
                                    "Зайдя в комнату слева вы увидели кабинет. В которм уже тоже давно никого не было.")
                                print("Всё было в прильнчом слое пыли, в углах даже паутина появилась. ")
                                print(
                                    "Вы осмотрели книжные полки и стол. Но кроме очень старых документов и книг вы ничего не нашли")
                                print("Вы пошли в комнату справа. Там была детская в которой уже давно никто не бывал.")
                    ...
                    print(
                        "Я так и не смог ничего заметить, чтоб меня это привело хоть на немного к разгадке этой серии убиств")
                    ...
                    def proof():
                        ...
                        if proof == "поиск улик":
                            ...
                            step = input(
                                "Что вы хотите сделать? (поговорить с главой отдела/поехать в полицейский участок): ")
                    ...
                    print(
                        "В этом переулке вы сразу же находите улики. Это следы крови. А пройдя чуть дальше и орудие убийства.")
        ...
        for i in range(3):
            ...
            def expertise():
                ...
                if expertise == "продолжать давить на подозреваемого":
                    print(
                        "В итоге путём допроса с отягощающими последствиями. Нам удалось выбить из него всю информацию")
                    print(
                    ...
                    print(
                        "Он решил сходить  и посмотреть что же это за зверь такой, что решил в его городе бесчинствовать.")
                    print(
                        "Но только увидев его он узнал в нём того, самого мальчика над которым они издевались в школе")
